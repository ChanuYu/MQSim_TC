...
namespace SSD_Components
{
    Flash_Mode_Controller::Flash_Mode_Controller(const sim_object_id_type& id, FTL* ftl,
            ...
            block_no_per_plane(block_no_per_plane), pages_no_per_block(page_no_per_block), sector_no_per_page(sector_no_per_page),initial_slc_block_per_plane(initial_slc_block_per_plane)
            {}
