...
namespace SSD_Components
{
	...
	public:
		NVM_Transaction_Flash_WR(Transaction_Source_Type source, stream_id_type stream_id,
			...
			NVM::memory_content_type content, NVM_Transaction_Flash_RD* related_read, page_status_type write_sectors_bitmap, data_timestamp_type data_timestamp, bool isSLCTrx = false);
		NVM_Transaction_Flash_WR(Transaction_Source_Type source, stream_id_type stream_id,
			...
			NVM_Transaction_Flash_RD* related_read, page_status_type write_sectors_bitmap, data_timestamp_type data_timestamp,bool isSLCTrx = false);
		NVM_Transaction_Flash_WR(Transaction_Source_Type source, stream_id_type stream_id,
			...
			page_status_type write_sectors_bitmap, data_timestamp_type data_timestamp,bool isSLCTrx = false);
		NVM_Transaction_Flash_WR(Transaction_Source_Type source, stream_id_type stream_id,
