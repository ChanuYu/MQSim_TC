...
namespace SSD_Components
{
    ...
    Tiering_Area_Controller_Base::Tiering_Area_Controller_Base(GC_and_WL_Unit_Base *gc_wl, Address_Mapping_Unit_Base *amu, Flash_Block_Manager_Base *block_manager, TSU_Base *tsu, NVM_PHY_ONFI_NVDDR2* flash_controller,/*unsigned short *p_on_the_fly_requests,*/
                                    unsigned int channel, unsigned int chip, unsigned int die, unsigned int plane, unsigned int block, unsigned int page)
                                    :gc_wl(gc_wl), amu(amu), block_manager(block_manager),tsu(tsu), flash_controller(flash_controller),/*p_on_the_fly_requests(p_on_the_fly_requests),*/
